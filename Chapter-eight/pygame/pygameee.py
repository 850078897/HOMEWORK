...
def game2():
    ...
    print(
        "You ran to the building and found a little boy in the corner, a thirteen-year-old boy, who saw you and suddenly raised an old handgun and buckled the board...")
...
def game3():
    ...
    print(
        "The boy's answer makes you very different: originally you are human, I still think be a zombie...Uh, your wound, Im sorry. ")

    print("The wound doesn't care about you kids, you just said...Zombies?!You asked in surprise.")

    print(
        "Well, you don't know yet?Yesterday, the city was infected by a word called 'brainless virus'. The infected human brain tissue will be destroyed and will continue to kill people...That is, zombies.The boy said.")
...
def game4():
    ...
    print(
        "Whats going on...You hold your head and your mind is confused, and suddenly you hear the Lubenwei saying, dont mind me, go, go, I have a heart attack, and there are zombies under the bed...Take this pistol...")
...
def newbee6():
    print("Finally you came to the street, you win")
def newbee7():
